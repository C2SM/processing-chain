...
def main(starttime, hstart, hstop, cfg):
    ...
    cfg.ctdas_sys_rc = os.path.join(cfg.ctdas_exec,'da','rc','cteco2','carbontracker_icon.rc')
    cfg.ctdas_case_rc = os.path.join(cfg.ctdas_exec,'ctdas-icon-' + cfg.ini_datetime_string + '.rc')
    cfg.ctdas_case_sys_rc = os.path.join(cfg.ctdas_exec,'da','rc','cteco2','carbontracker_icon_' + cfg.ini_datetime_string +'.rc')
    cfg.ctdas_rc = os.path.join(cfg.ctdas_exec,'ctdas-icon.rc')
    cfg.ctdas_ini_datetime_string = cfg.ini_datetime_string.replace('T', ' ').replace('Z', '')
    cfg.ctdas_end_datetime_string = cfg.end_datetime_string.replace('T', ' ').replace('Z', '')
