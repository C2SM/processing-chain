...
def fetch_era5_nudging(date, dir2move):
    ...
    shutil.move('era5_ml_nudging.grib', os.path.join(dir2move, 'era5_ml_nudging.grib'))
    shutil.move('era5_surf_nudging.grib', os.path.join(dir2move, 'era5_surf_nudging.grib'))
