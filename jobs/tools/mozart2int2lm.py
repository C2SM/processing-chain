...
def main(_, source_file, target_dir, __):
    """Wrapper for mozart2int2lm.sh
    Assumes the this file is in the same directory as mozart2int2lm.sh.
    source_file and target_dir are forwarded to the bash script.
    """
