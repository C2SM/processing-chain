...
# -*- coding: utf-8 -*-
#
# Processing Chain documentation build configuration file, created by
...
copyright = '2018-2021'
author = 'processing_chain Developers'
...
latex_documents = [
    (master_doc, 'ProcessingChain.tex', 'Processing Chain Documentation',
     'Abt 503', 'manual'),
]
