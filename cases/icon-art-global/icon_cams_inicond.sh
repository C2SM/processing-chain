...
ncks -A -v TRCH4 tmp.nc {cfg.inicond_filename_scratch}
rm tmp.nc

cdo expr,'TRCO=QV / QV * 0.0000002;' {cfg.inicond_filename_scratch} tmp.nc
ncks -A -v TRCO tmp.nc {cfg.inicond_filename_scratch}
rm tmp.nc
