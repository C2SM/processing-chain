...
# output
output_root = '/scratch/snx3000/mjaehn/Carbosense/output'
...
chain_src_dir = '/users/mjaehn/svn/cosmo_processing_chain'
...
int2lm_extpar_file = 'external_parameter_mch_cosmo1_aster.nc'
