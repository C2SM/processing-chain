...
"""
  ...
  lasync_io      = .TRUE., 
  lbdclim        = .TRUE.,
  ngribout       = 4,         ! number of output files (defines # GRIBOUT sections)
  yform_read     = "ncdf", 
...
&GRIBOUT
  ...
  yform_write ='ncdf',   ! grb1 or ncdf
  hcomb       = 0,8761,1,
  yvarml = 'CO2_BG','CO2_TOT','CO2_RA','CO2_GPP',
  l_z_filter       = .FALSE.,
  l_p_filter       = .FALSE.,
  luvmasspoint     = .FALSE.,
  l_fi_pmsl_smooth = .FALSE.,
...
&GRIBOUT
  ...
  yform_write ='ncdf',   ! grb1 or ncdf
  hcomb       = 0,8761,1,
  yvarml = 'CO_BG','CO_TOT','CH4_BG','CH4_TOT',
  l_z_filter       = .FALSE.,
  l_p_filter       = .FALSE.,
  luvmasspoint     = .FALSE.,
  l_fi_pmsl_smooth = .FALSE.,
...
"""
 ...
 hd_corr_trcr_bd  = 0.75,
 hd_corr_p_in     = 0.0,
 hd_corr_u_in     = 0.15,  ! MeteoSwiss COSMO-1: 0.0
 hd_corr_trcr_in  = 0.25,  ! MeteoSwiss COSMO-1: 0.0
 hd_corr_t_in     = 0.0,
 hd_dhmax         = 250.,
 ldiabf_lh        = .TRUE.,
 lexpl_lbc        = .TRUE.,
 ...
 nrdtau           = 3,
 xkd              = 0.1,
 rlwidth          = 20000.,  ! Should be at least 15 grid points (MeteoSwiss COSMO-1: 35000)
