import os
"""
Configuration file for the 'cosmo-art-nested-test' case with COSMO-ART
"""
...
emissions_dir = [
    os.path.join(input_root, 'emissions', 'emissions_nest_MACC_noSwiss'),
    os.path.join(input_root, 'emissions', 'emissions_nest_ch')
]
...
values_to_check = {
    ("reference_nested_lffd2015020412.nc", "lffd2015020412.nc"): None
}
